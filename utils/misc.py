...
#############################
    ...
    final_batch["samples"] = NestedTensor.from_tensor_list(batch[0][0], do_round)

    # print("1111111111111111111111111111111111111111111111111")
    # print("samples: ")
    # print(final_batch["samples"].tensors.shape)
#############################
...
def targets_to(targets: List[Dict[str, Any]], device):
    ...
    return [{k: v.to(device) if k not in excluded_keys else v for k, v in t.items() if (k != "caption" and k != 'object')} for t in targets]
