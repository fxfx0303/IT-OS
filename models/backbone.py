...
##############################
        ...
        # )
        # backbone.load_state_dict(torch.load("video_text/mdetr-main/checkpoint/pretrained_resnet101_checkpoint.pth"))
...
def build_backbone(args):
    train_backbone = args.lr_backbone
    return_interm_layers = (args.masks == 1)
    dilation = (args.dilation == 1)
    if args.backbone in ("resnet50-gn", "resnet101-gn"):
        backbone = GroupNormBackbone(args.backbone, train_backbone, return_interm_layers, dilation)
    else:
