...
class Transformer(nn.Module):
    ...
    def __init__(self, d_model=512,
        ...
        pretrain_model_path = "video_text/mdetr-main/transformer_pretrain"
        self.tokenizer = RobertaTokenizerFast.from_pretrained(pretrain_model_path)
        self.text_encoder = RobertaModel.from_pretrained(pretrain_model_path)
    ...
    def forward(self,
        ...
        if encode_and_save:
            ...
            if isinstance(text[0], str):
                ...
                # Encode the text
                tokenized = self.tokenizer.batch_encode_plus(text, padding="max_length", max_length=24, return_tensors="pt").to(device)
                encoded_text = self.text_encoder(**tokenized)
...
############################
            ...
            text_memory = memory[-len(text_memory_resized) :]
            ...
            memory_cache = {
                ...
                "img_pooled_op": memory[0] if self.CLS is not None else None,  # Return the CLS token
                "mask": mask,
            ...
            assert memory.shape[1] == text_memory.shape[1] == tgt.shape[1]
