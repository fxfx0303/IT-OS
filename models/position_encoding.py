...
class PositionEmbeddingSine(nn.Module):
    ...
    def __init__(self, num_pos_feats=64, num_frames = 36, temperature=10000, normalize=False, scale=None):
        ...
        ##384维投影到256维
        self.dim_proj = nn.Linear(num_pos_feats*3, num_pos_feats*2, bias=False)
...
# #######################
        ...
        # print("pos_x: ")
        # print(pos_x.shape)
        # print(pos_x[:, :, :, :, 0::2].shape)
        # print(pos_x[:, :, :, :, 1::2].shape)
        # exit()
