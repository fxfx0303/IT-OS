...
from utils.box_ops import box_cxcywh_to_xyxy, generalized_box_iou, multi_iou
INF = 100000000
...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        for i in range(bs):
            ...
            # print("out_prob_split: ")
            # print(out_prob_split.shape)
            ...
            # print("out_prob_split[:,frame_index,tgt_ids]: ")
            # print(out_prob_split[:,frame_index,tgt_ids].shape)
            #
            # print("frame_index:")
